    ...
    <>
      <div className="w-[80%] sm:w-[50%] md:w-[50%] lg:w-[50%] xl:w-[30%] p-5 sm:p-10  shadow-2xl rounded-lg  mx-auto mt-10">
        ...
        <form onSubmit={handleSubmit} className="mt-8">
          ...
          <div className="mt-4">
            <Link to="#">
              <h1 className="text-[#64666C] text-xl font-semibold">
                Forgot Password
              </h1>
            </Link>
          </div>
          ...
          <div className="mt-5">
            <span className="text-[#64666C] text-lg font-semibold pr-2">
              Not a Member?
            </span>

            <Link
              to="/register"
              className="text-[#0066b2] text-lg font-semibold"
            >
              Register
            </Link>
