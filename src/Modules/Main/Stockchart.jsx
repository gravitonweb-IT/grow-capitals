        ...
        <div className="tv-category__tab-description-content">
          <div className="tv-category-description">
            ...
            <p className="tv-category-description__text">
              ...
              multiplying the stock price by the number of stocks outstanding.
              Here you can see the companies with the largest market cap.
              Large-cap stocks are usually industry and sector leaders and
              represent well-known, established companies.
            </p>
          </div>
        </div>
      </div>
                        ...
                        >
                          <div className="headCellTitle-MSg2GmPp">
                            ...
                            <div className="bottomLine-MSg2GmPp">
                              <div className="paramTitle-MSg2GmPp">(TTM)</div>
                            </div>
                          </div>
                        </div>
                      </th>
                  ...
                  <table className="table-Ngq2xrcG">
                    <thead className="tableHead-RHkwFEqU">
                      <tr className="row-RdUXZpkv">
                        ...
                        <th className="cell-seAzPAHn" data-field="MarketCap">
                          <div
                            className="cellWrapper-RfwJ5pFm cellContent-seAzPAHn apply-common-tooltip right-RfwJ5pFm"
                            title="Market capitalization"
                          >
                    ...
                    <tbody tabIndex={100}>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          15.658T
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          2318.70
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.777M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.33</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">24.23</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          95.71
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−3.17%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.853M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.04</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">30.00</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          119.55
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">13.66%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.69</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">17.69</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          87.10
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">22.33%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">6.851M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.43</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">17.96</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          52.35
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">33.89%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">4.099M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.84</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">24.68</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          59.15
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">11.63%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          ...
                          <div className="container-ibwgrGVw neutral-ibwgrGVw">
                            <span className="ratingIcon-ibwgrGVw">
                              <svg
                                ...
                                height={18}
                              >
                                <path fill="currentColor" d="M5 9h9v1H5V9Z" />
                              </svg>
                            </span>
                            Neutral
                          </div>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.59</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">57.51</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          43.81
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">12.33%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.592M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.63</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">27.33</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          16.00
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">20.56%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">8.723M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.53</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">7.89</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          74.92
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">89.30%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.186M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.40</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">66.17</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          14.01
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">44.55%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.17</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.53</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">38.74</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          203.38
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">43.14%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      <tr className="row-RdUXZpkv listRow" data-rowkey="NSE:LT">
                        <td className="cell-RLhfr_y4 left-RLhfr_y4 cell-fixed-ZtyEm8a1 onscroll-shadow">
                          <span className="tickerCell-GrtoTeat">
                            <span>
                              <div className="uiMarker-erqqoDve flag-t3Qyc4SH">
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.529M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.64</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">38.39</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          80.08
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">23.75%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.29</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">8.59</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          74.35
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.944M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.42</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">21.17</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          82.15
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">25.44%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.63%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.584M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.83</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">22.11</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          55.71
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">11.25%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.106M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.48</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">24.94</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          40.29
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−23.21%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.36</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">31.64</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          321.11
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">118.43%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.59</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">66.21</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          48.37
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">33.37%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.81%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.75</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">88.83</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          36.25
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.22%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          770.232K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.51</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">104.73</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          23.49
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">167.72%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.56%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.215M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.61</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">31.79</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          35.16
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">116.88%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.06</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">105.94</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          36.71
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">17.47%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.50</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">34.99</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          44.20
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">39.73%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.05%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.35</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">45.50</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          179.16
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−28.46%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.46%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.27%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">6.22M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.57</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">6.09</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          29.92
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−26.88%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.70%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">15.69M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.91</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">12.69</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          18.41
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">4.158M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.54</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">22.33</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          27.56
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.65</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">81.16</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          283.29
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">29.20%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.99%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.586M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.50</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">19.24</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          21.14
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.01M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.35</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">14.71</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          103.69
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">38.81%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">1.06%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.51%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">7.63M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.40</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">11.98</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          16.36
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.18%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          724.796K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.32</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">32.38</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          23.33
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−63.90%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.33%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.252M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.39</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">28.16</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          29.19
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">33.90%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.36%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">4.392M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.41</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">6.48</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          44.30
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">18.60%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.10%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          191.628K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.04</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">142.15</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          6.83
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">120.73%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.53</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">35.10</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          148.90
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.52</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">94.04</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          1.33
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−95.82%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">8.408M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.47</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.71%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.284M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.08</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">9.69</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          38.13
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">56.23%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.93</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">21.49</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          230.63
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.62%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.837M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.85</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">93.58</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          6.64
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.59%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.30%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.457M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.52</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">62.44</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          8.46
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">28.16%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.74%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.73%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          174.498K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.29</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">13.78</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          22.21
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−12.62%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">20.04%</span>
                        </td>
                        <td className="cell-RLhfr_y4 left-RLhfr_y4">
                          <a
                            href="/markets/stocks-india/sectorandindustry-sector/non-energy-minerals/"
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.60</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">69.20</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          18.37
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">19.00%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.19%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.6M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.43</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.16</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          17.34
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">27.60%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.58</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">74.67</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          47.34
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">38.99%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.49%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          267.78K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.38</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">19.17</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          98.44
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−17.18%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.46</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">89.16</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          27.28
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.458M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.72</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">63.71</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          14.46
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">44.68%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.19%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.19%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.456M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.53</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">24.25</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          49.60
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−17.77%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.05%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">7.85M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.38</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">6.30</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          33.67
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">102.38%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.43%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          94.518K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.26</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">44.52</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          101.38
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">65.81%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.37%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.051M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.30</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">13.66</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          102.20
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">46.23%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.61%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.74M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.49</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">12.42</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          37.90
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−43.98%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">9.689M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.68</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">32.18</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          4.32
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">15.22%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.36%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          751.151K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.79</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">59.61</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          16.39
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−2.26%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.85%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.311M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.00</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">34.75</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          34.17
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">17.71%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.16%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.68%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          814.387K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.52</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">56.63</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          9.74
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.99%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.79%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          204.025K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.68</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">66.10</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          55.65
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−52.43%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.81%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.93%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          14.131M
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.28</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">15.59</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          4.77
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.28%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.46%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.60</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">30.14</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          38.54
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">25.12%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.29</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">29.21</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          117.58
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">57.02%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.99</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">24.63</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          99.61
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−21.10%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.39%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.13</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">72.51</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          11.16
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">28.90%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.06%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          201.186K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.46</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">19.09</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          283.66
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">58.66%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.48</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">40.19</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          1.17
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">24.78%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−3.82%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          95.514M
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.01</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">19.16</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          4.00
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">48.24%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.78%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.78</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">79.28</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          17.81
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−7.36%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.27</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">—</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          −0.94
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">31.96%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.21</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">43.80</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          9.88
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−28.05%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.82</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">82.48</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          49.24
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">95.59%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.09%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">7.298M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.40</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">9.48</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          23.55
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−53.78%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">38.34%</span>
                        </td>
                        <td className="cell-RLhfr_y4 left-RLhfr_y4">
                          <a
                            href="/markets/stocks-india/sectorandindustry-sector/non-energy-minerals/"
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">4.29M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.50</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">23.43</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          10.99
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">63.84%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.54%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">4.816M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.25</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">4.65</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          51.66
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">22.20%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−2.86%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          30.767M
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.57</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">7.06</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          14.92
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">78.03%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.31%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          390.022K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.28</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">63.16</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          13.65
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">25.01%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.97%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.09%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">266.4K</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.17</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">91.99</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          6.00
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−21.32%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.11%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">8.189M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.73</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">19.43</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          6.32
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−68.54%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.69%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          153.895K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.23</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">54.63</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          96.59
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">48.87%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.37%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.34%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          22.574K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.40</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">14.14</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          475.92
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">24.73%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.92%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          443.312K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.27</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">33.53</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          23.41
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">14.70%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.31%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.08%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.438M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.41</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">17.75</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          3.88
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">54.09%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">1.42%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.80%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">7.398M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.32</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">6.27</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          44.36
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">14.28%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.574M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.68</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">3.93</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          87.51
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">587.18%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−4.40%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">2.681M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.43</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">51.96</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          10.50
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.41</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">108.91</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          46.50
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−24.32%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.55</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">184.22</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          4.11
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−70.20%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.13%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.77%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          50.054K
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.24</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">149.44</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          13.72
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">34.37%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.11%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">354.6K</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.56</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">52.92</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          18.97
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">29.51%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="neutral-p_QIAEOQ">0.00%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.39%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          351.139K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.27</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">48.57</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          30.68
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">35.88%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.11%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          736.114K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.49</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">10.97</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          166.76
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">28.04%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.35</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">23.82</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          28.54
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−62.32%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.29%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−0.41%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">1.85M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.27</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">56.74</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          7.35
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−41.87%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.45%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.439M</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.40</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">5.26</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          70.63
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">79.33%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.72</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">119.47</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          5.08
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">10.52%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−8.96%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="positive-p_QIAEOQ">0.32%</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          <span className="negative-p_QIAEOQ">−1.05%</span>
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          408.077K
                        </td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.34</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">62.96</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          6.79
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
                      ...
                      >
                        ...
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">0.14</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">68.50</td>
                        <td className="cell-RLhfr_y4 right-RLhfr_y4">
                          8.24
                          <span className="currency-WyLKdeog"> {/* */}INR</span>
                        </td>
