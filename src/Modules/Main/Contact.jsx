    ...
    <>
      ...
      <div className="flex justify-center">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-10 md:mx-20 lg:mx-32 mt-10 md:mt-20">
          ...
          <div className="  bg-blue-500 border rounded-xl shadow-top-md  p-9 sm:p-3 lg:p-12">
          ...
          <div className="bg-white  lg:col-span-2 shadow-top-md px-0 sm:px-20  md:px-20  lg:px-20  ">
            ...
            <form>
              ...
              {registrationSuccess && (
                ...
                <p className="text-green-500 mb-2">Your details has been successfully Submitted!</p>
              ...
              <button
                ...
                class="bg-blue-500 hover:bg-white text-white hover:text-black border-2 border-blue-500 text-lg  font-bold rounded-full w-[140px]  h-[40px] p-1 transition duration-300 ease-in-out"
