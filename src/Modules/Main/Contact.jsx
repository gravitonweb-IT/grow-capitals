          ...
          <div className="bg-white  lg:col-span-2 shadow-top-md px-0 sm:px-20  md:px-20  lg:px-20  ">
            ...
            <form>
              ...
              <div className="grid grid-cols-2 gap-5 pb-4 pt-4">
                ...
                <button type="submit" onClick={submitHandle} class="bg-blue-500 hover:bg-white text-white hover:text-black border-2 border-blue-500 text-lg  font-bold rounded-full w-[140px]  h-[40px] p-1 transition duration-300 ease-in-out">
