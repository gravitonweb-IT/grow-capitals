...
const Withdraw = () => {
  ...
  <div className="flex flex-col items-start sm:flex-row sm:items-center my-2 pl-2">
    ...
    />
    <p className="text-2xl font-bold text-blue-500 mt-4 sm:mt-0 sm:ml-2 lg:pl-[380px]">Withdraw Data Table</p>
  </div>
</div>
          ...
          <tbody>
            ...
            {data.map((item) => (
              ...
              <tr className="border" key={item.id}>
                ...
                <td className="p-2 text-center font-semibold bg-slate-300">{item.name}</td>

                <td className="p-2 text-center">{item.Account_No}</td>

                <td className="p-2 text-center font-semibold bg-slate-300">{item.ifsc}</td>

                <td className="p-2 text-center">{item.panNo}</td>

                <td className="p-2 text-center font-semibold bg-slate-300">{item.price}</td>
